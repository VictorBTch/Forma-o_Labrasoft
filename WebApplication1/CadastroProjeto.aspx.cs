...
namespace WebApplication1
{
    public partial class CadastroProjeto : BasePage
    {
        ...
        private void CarregarDadosIniciais()
        {
            ...
            // Preenche Alunos
            lstAlunos.DataSource = bolsistaRepository.ListarBolsistasDisponiveis();
        ...
        protected void gridProjetos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "VerDetalhes")
            {
                ...
                CarregarDetalhesProjeto(idProjeto);  
        ...
        protected void btnEditarBolsistas_Click(object sender, EventArgs e)
        {
            ...
            lstDisponiveis.DataSource =
                bolsistaRepository.ListarBolsistasDisponiveis();
        ...
        private void CarregarDetalhesProjeto(int idProjeto)
        {
            ...
            // Bolsistas
            if (projeto.AlunosVinculados != null &&
                projeto.AlunosVinculados.Count > 0)
            {
            ...
            // Despesas
            if (projeto.Despesas != null &&
                projeto.Despesas.Count > 0)
            {
